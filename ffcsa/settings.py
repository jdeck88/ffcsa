...
DROPSITES = [
    ...
    },
    {
        ...
        'memberLimit': 30,
        'color': 'white',
        'description': 'Eugene - W 11th; W 11th & Van Buren (Tuesday)',
    ...
    },
    {
        ...
        'memberLimit': 30,
        'color': 'green',
        'description': 'Eugene - Friendly; Charnelton St & 26th (Tuesday)',
        'allowOneTimeOrders': False,
        'pickupDay': 2,
        'members_only': True,
        'DFFDelivery': False,
   ...
   },
   {
       ...
       'memberLimit': 40,
       'color': 'green',
       'description': 'Portland - PSU; PSU Farmers Market (Saturday)',
       'allowOneTimeOrders': True,
       'pickupDay': 6,
       'members_only': False,
       'DFFDelivery': True,
   },
   {
       ...
       'memberLimit': 60,
       'color': 'yellow',
       'description': 'Portland - Hollywood; Hollywood Farmers Market / Henkle Residence (Saturday)',
       'allowOneTimeOrders': True,
       'pickupDay': 6,
       'members_only': False,
       'DFFDelivery': True,
   },
   {
       ...
       'memberLimit': 30,
       'color': 'red',
       'description': 'Portland - Cully; Killingsworth & NE 60th (Saturday)',
       'allowOneTimeOrders': False,
       'pickupDay': 6,
       'members_only': True,
       'DFFDelivery': True,
   },
   {
       ...
       'memberLimit': 30,
       'color': 'cyan',
       'description': 'Portland - Irvington; NE 10th Ave (Saturday)',
       'allowOneTimeOrders': False,
       'pickupDay': 6,
       'members_only': True,
       'DFFDelivery': True,
   },
   {
       ...
       'memberLimit': 30,
       'color': 'white',
       'description': 'Portland - Woodstock; SE 50th Ave (Saturday)',
       'allowOneTimeOrders': False,
       'pickupDay': 6,
       'members_only': True,
       'DFFDelivery': True,
   },
   {
       ...
       'memberLimit': 20,
       'color': 'purple',
       'description': 'Portland - St Johns; St Johns Farmers Market / N Dana Ave. (Saturday)',
       'allowOneTimeOrders': False,
       'pickupDay': 6,
       'members_only': False,
       'DFFDelivery': True,
   },
   {
       ...
       'memberLimit': 25,
       'color': 'orange',
       'description': 'Corvallis - Corvallis; SW Hawkeye & SW Brooklane (Friday)',
       'allowOneTimeOrders': False,
       'pickupDay': 5,
       'members_only': True,
       'DFFDelivery': False,
   },
   {
    ...
    # # ('Woodstock', 'Portland - Woodstock; Woodstock Farmers Market (Sunday)'),
    # DROP_SITE_COLORS = {
    # 'Woodstock': 'yellow',
    # }
]
    ...
    4: [
        {
            ...
            'standingDeliveries': [
                ...
                ['3355 SW Hawkeye, Corvallis, OR 97333', 'Corvallis Dropsite', '', '', '', '8', '3:30PM', '8:00PM',
                 '', '', '', '', 'none'],
