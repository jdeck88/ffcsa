...
DROPSITES = [
    ...
    },
    {
        ...
        'memberLimit': 30,
        'color': 'green',
        'description': 'Eugene - Charnelton St & 26th (Tuesday)',
        'allowOneTimeOrders': False,
        'pickupDay': 2,
        'members_only': True,
        'DFFDelivery': False,
   ...
   },
   {
       ...
       'memberLimit': 60,
       'color': 'yellow',
       'description': 'Portland - Hollywood Farmers Market / Henkle Residence (Saturday)',
       'allowOneTimeOrders': True,
       'pickupDay': 6,
       'members_only': False,
       'DFFDelivery': True,
   ...
   },
   {
       ...
       'memberLimit': 20,
       'color': 'purple',
       'description': 'Portland - St Johns Farmers Market / N Dana Ave. (Saturday)',
       'allowOneTimeOrders': False,
       'pickupDay': 6,
       'members_only': False,
       'DFFDelivery': True,
   },
   {
       ...
       'memberLimit': 25,
       'color': 'orange',
       'description': 'Corvallis - SW Hawkeye & SW Brooklane (Friday)',
       'allowOneTimeOrders': False,
       'pickupDay': 5,
       'members_only': True,
       'DFFDelivery': False,
